...
describe('state:epics', () => {
  describe('questionRequested', () => {
    it(`handles a ${NEXT_QUESTION_REQUESTED} action with either a ${NEXT_QUESTION_ACTIVATED} when next question is permitted otherwise return a ${ERROR_QUESTION_INDEX_OUT_OF_BOUNDS} action`, () => {
    ...
    it(`handles a ${PREVIOUS_QUESTION_REQUESTED} action with either a ${PREVIOUS_QUESTION_ACTIVATED} when next question is permitted otherwise return a ${ERROR_QUESTION_INDEX_OUT_OF_BOUNDS} action`, () => {
      makeTestScheduler().run(({ hot, cold, expectObservable }) => {
        const action$ = hot('ab', {
    ...
    it(`handles a ${QUESTION_REQUESTED} action with either a ${REQUESTED_QUESTION_ACTIVATED} when next question is permitted otherwise return a ${ERROR_QUESTION_INDEX_OUT_OF_BOUNDS} action`, () => {
      makeTestScheduler().run(({ hot, cold, expectObservable }) => {
        const action$ = hot('ab', {
