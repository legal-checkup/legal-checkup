  ...
  return (
    <>
      ...
      <QuestionAnswerWrapper>
        ...
        <PageText format={format}>
          We’ve added example text to all the questions we think people could
          have trouble with - but if you find a question that you think needs
          it, please talk to your local Community Law representative.
        </PageText>
      </QuestionAnswerWrapper>
      <QuestionAnswerWrapper>
        <PageQuestion>What happens to my information?</PageQuestion>
        <PageText format={format}>
          Nothing! We don’t store, save or distribute your information in any
          way. Only you know what you answered, and as soon as you leave the
          results page - no one (including you) can get your results or answers
          back.
        </PageText>
      </QuestionAnswerWrapper>
      <QuestionAnswerWrapper>
      ...
      <QuestionAnswerWrapper>
        ...
        <PageText format={format}>
          Oh dear. We’re sorry to hear that. Unfortunately there isn’t anything
          we can do to get your progress back. Please start the checkup again -
          it will only take 5 minutes to complete.
        </PageText>
      </QuestionAnswerWrapper>
      <QuestionAnswerWrapper>
